...
namespace PWCApp
{
    public class PlanHandler
    {
        ...
        private string url = "https://pwbackendapi.azurewebsites.net/api/JobsAssigneds";
        ...
        public List<JobsAssigned> ExecuteGetRequest()
        {
            ...
            var objRoot = JsonConvert.DeserializeObject<List<JobsAssigned>>(response.Content);

            return objRoot;
        }

        public JobsAssigned ExecuteGetSelectedRequest(int id)
        {
            var client = new RestClient("https://pwbackendapi.azurewebsites.net/api/JobsAssigneds" + "/" + id);

            request = new RestRequest();

            response = client.Execute(request);

            var objRoot = JsonConvert.DeserializeObject<JobsAssigned>(response.Content);
